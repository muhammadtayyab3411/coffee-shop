...
let intro_section_heading_Text = `Customer Support`;
let intro_section_paragraph_Text = `Your most unhappy customers are your greatest source of learning`;
...
root.style.setProperty("--intro_section_bg_img_url", `url("../images/customer_support_bg.jpg")`);
